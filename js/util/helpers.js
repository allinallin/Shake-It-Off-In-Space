define('Helpers', [
	...
	Helpers = {
		/**
		 * Execute any helpers that need to be attached to
		 * another object (e.g. window)
		 */
		init: function() {
		...
		/**
		 * Add/replace properties of a target object from a source object
		 * @param  {Object} dest   object to add or replace properties
		 * @param  {Object} source object to copy properties
		 */
		 ...
		 */
		numIsInBetween: function(val, min, max) {
		...
		detectOverlap: function (rect1, rect2) {
			var a = {
					x: rect1.x,
					y: rect1.y,
